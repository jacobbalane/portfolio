...
const SectionButton: React.FC<SectionButtonProps> = ({ label }) => {
  return (
    <div className="flex justify-center items-center w-fulllg:h-full mt-8 mb-12 md:mt-14 md:mb-20 xl:mb-40">
      <button className="w-40 md:w-56 lg:w-72 xl:w-96 flex justify-center items-center space-x-3 px-5 md:px-8 lg:px-10 xl:px-12 py-3 lg:py-5 text-2xs md:text-lg xl:text-2xl font-medium bg-primary text-secondary rounded-full shadow-md">
        <p>{label}</p>
