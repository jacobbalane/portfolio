...
const Header: React.FC<HeaderProps> = ({ main, sub, handleToggle, offset }) => {
  ...
  return (
    <div
      className={`sticky top-0 bg-secondary z-10 overflow-hidden px-8 md:px-16 ${
        offset > 0 ? "border-b border-accent-2" : ""
      }`}>
      <div className="flex justify-between items-center h-32 md:max-w-[50rem] lg:max-w-[60rem] xl:max-w-[75rem] mx-auto">
