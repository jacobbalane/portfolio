...
export default function Hero() {
  return (
    <section className="min-h-[40rem] md:max-w-mdMaxWidth lg:max-w-lgMaxWidth px-8 md:px-16 mx-auto flex flex-col justify-center h-[30rem] md:h-[50rem] space-y-10 md:space-y-20">
